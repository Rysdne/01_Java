...
<body>
	...
	<div class="container mt-3">
		...
		<table class="table table-striped">
			...
			%>
			<tr>
				<td><input type="checkbox" name="check" value="<%=rs.getInt("idx")%>"></td>
				<td><%=rs.getInt("idx")%></td>
		...
		<button type="button" class="btn btn-success" onclick="location.href='/delete/deleteChecked.jsp'">삭제</button>
