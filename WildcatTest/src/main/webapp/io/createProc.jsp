...
<body>
	...
	// 프로젝트 내부에 저장
	// 저장 경로 : C:\Users\Rysdne\Desktop\Rysdne\Document\01. Java\work\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WildcatTest\WEB-INF
	...
	String sql="insert into WildcatTest values(?,?,?,?,?,?)";
	...
	메모가 저장되었습니다
	<br>
	<button onclick="location.href='/WildcatTest/index.jsp'">돌아가기</button>
</body>
</html>