...
public class SungjukDAO {
	...
	private static SungjukDAO dao = new SungjukDAO();
	...
	public Connection connect() {
		...
		try {
			...
			conn = DriverManager.getConnection("jdbc:oracle:thin:@192.168.0.53:1521:xe", "test", "1111");
			if (conn != null)
	...
	public void insert(Sungjuk sj) {
		...
		try {
			...
			pstmt.setInt(3, sj.getKor());
			pstmt.setInt(4, sj.getEng());
			pstmt.setInt(5, sj.getMath());
			pstmt.executeUpdate();
		} catch (Exception ex) {
			System.out.println(ex);
		} finally {
