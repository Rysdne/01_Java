...
@WebServlet("/addnEqual")
public class AddnEqual extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 입력값이 공백일 경우 아무런 변화가 없도록 하기 위해 localNum을 0으로 초기화
		if (inputNum.equals("")) {
			localNum = 0;
		...
		if (op.equals("+")) {
			...
			resp.sendRedirect("http://localhost:8080/AddnEqual.html");
