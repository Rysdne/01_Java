...
<script src="/WildcatTest/jquery-3.6.0.min.js"></script>
<%
...
<script>
	$(document).ready(function() {
		$('tr').click(function() {
			...
			location.href = "/WildcatTest/io/overwrite.jsp?idx=" + idx + "&id=" + id + "&subFolderName=" + subFolderName + "&title=" + title;
		});
...
<body>
	...
	String sql = "select * from WildcatTest where id=? and idx like ? order by idx desc";
	...
	<button onclick="location.href='/WildcatTest/index.jsp'">메인 메뉴</button>
</body>
</html>