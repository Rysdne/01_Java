...
<body>
	<form id="form" action="/WildcatTest/io/createProc.jsp" method="post">
		
		<span style="font-weight: bold">계정</span><br>
		<input readonly type="text" id="id" name="id" value="<%=session.getAttribute("id")%>"><button onclick='location.href="/WildcatTest/login/logout.jsp"'>로그아웃</button><br>
