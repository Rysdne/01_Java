...
%>
	<form id="form" action="/WildcatTest/io/overwriteProc.jsp" method="post">

		<input readonly type="hidden" name="idx" value="<%=idx%>">

		<span style="font-weight: bold">계정</span><br>
		<input readonly type="text" id="name" name="id" value="<%=session.getAttribute("id")%>"><button onclick='location.href="/WildcatTest/login/logout.jsp"'>로그아웃</button><br>
